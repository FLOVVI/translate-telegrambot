...
def handle_text(message):
    ...
    if get_value.get_spelling():
        message_translation = translate.auto_spelling(text, get_value.get_language())
        ...
        bot.send_message(message.chat.id, translate.translate(text, get_value.get_language()))
